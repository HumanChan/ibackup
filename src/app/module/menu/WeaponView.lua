...
local WeaponViewCell = require("app.module.menu.WeaponViewCell")
...
local WeaponView = class("WeaponView", require("app.core.BaseView"))

function WeaponView:ctor(name)
    WeaponView.super.ctor(self, name)
end

function WeaponView:initView()
    ...
    for i=1,6 do
        ...
        local content = WeaponViewCell.new()
        content:setData(i)
    ...
    self.buttonBack = cc.ui.UIPushButton.new("#button_empty_red_1.png")
        ...
        :onButtonClicked(function(event)
            ViewMgr:closeView(ViewConst.WeaponView)
...
function WeaponView:data(value)
end

function WeaponView:setBlack()
